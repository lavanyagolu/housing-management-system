...
$user = $_SESSION['username']; 
			$qu = mysqli_query($db, "SELECT * FROM `messages` WHERE `from`='$user' and `to_delete`='0'");
		if (mysqli_num_rows($qu) > 0) {
		          echo '<table border="1" cellpadding="10">';
echo '<tr><th>To</th> <th>Subject</th> <th>Date</th></tr>';
...
//echo '<td><a href="view.php?id=' . $row['id'] . '">View</a> | <a href="sentdelete.php?id=' . $row['id'] . '" onClick="return confirm(\'Are you sure you want to delete?\')">Delete</a></td>';


echo '<td><a href=""  onClick="PopupCenter(\'view.php?id=' . $row['id'] . '\',\'500\',\'300\')">Message</a> | <a href="sentdelete.php?id=' . $row['id'] . '" onClick="return confirm(\'Are you sure you want to delete?\')">Delete</a></td>';
echo "</tr>";
}
}
} else {
    echo 'You do not have any sent items.';
}
 echo "</table>";
		?>
